...
docker tag model_gpu us-central1-docker.pkg.dev/${PROJECT_ID}/${ARTIFACT_REGISTRY_REPO}/model_gpu:${TIMESTAMP}
echo "Push Docker image"
gcloud auth configure-docker us-central1-docker.pkg.dev
docker push us-central1-docker.pkg.dev/${PROJECT_ID}/${ARTIFACT_REGISTRY_REPO}/model_gpu:${TIMESTAMP}
